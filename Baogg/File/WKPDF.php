<?php
	...
	$GLOBALS['WKPDF_BASE_PATH']= BAOGG_UPLOAD_DIR.'tmp/';
	$GLOBALS['WKPDF_BASE_SITE']= 'file://';
	...
	class Baogg_File_WKPDF {
		...
		protected static $_cmd='wkhtmltopdf';
		/**
...
// TODO: use uname -m or -a
		...
		public function __construct(){
			if(!is_dir($GLOBALS['WKPDF_BASE_PATH'])){
				mkdir($GLOBALS['WKPDF_BASE_PATH'], 0777, true);
			}
		...
		public function set_html($html){
			...
			$this->url=$GLOBALS['WKPDF_BASE_SITE'].$GLOBALS['WKPDF_BASE_PATH'].basename($this->tmp);
		}
		/**
		...
		public function render(){
			...
			/*echo __FILE__.__LINE__.'<pre>';echo (self::_getOS()!='win' ? $this->cmd : 'cd '.escapeshellarg(dirname($this->cmd)).' && '.basename($this->cmd))
